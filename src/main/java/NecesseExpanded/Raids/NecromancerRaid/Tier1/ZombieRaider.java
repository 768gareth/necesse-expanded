...
public class ZombieRaider extends ItemAttackerRaiderMob
{
    public ZombieRaider() 
    {
        super(false);
        ...
        (
            new InventoryItem("ironsword"),
            new InventoryItem("ironspear")
        );
    }
            ...
            { 
                ...
                (
                    ...
                    { 
                        ...
                        (
                            (LootItemInterface) LootItem.between("copperore", 1, 4),
                            (LootItemInterface) LootItem.between("ironore", 1, 4),
    ...
    HumanDrawOptions humanOptions = (new HumanDrawOptions(level, MobRegistry.Textures.zombie)).sprite(sprite).mask(swimMask).dir(dir).light(light);
    if (inLiquid) {
    ...
    public void drawOnMap(TickManager tickManager, Client client, int x, int y, double tileScale, Rectangle drawBounds, boolean isMinimap) 
    {
        ...
        HumanDrawOptions humanOptions = (new HumanDrawOptions(getLevel(), MobRegistry.Textures.zombie)).sprite(sprite).dir(dir).size(32, 32);
