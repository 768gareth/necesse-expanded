...
public class KnightOfDuskBuff extends Buff
{
    @Override
    ...
    public void onHasAttacked(ActiveBuff Buff, MobWasHitEvent Event)
    {
        ...
        {
            Event.target.buffManager.addBuff(new ActiveBuff(BuffRegistry.getBuff("moonscorched"), Event.target, 8.0F, Event.attacker), true);
        }
    } 
}
