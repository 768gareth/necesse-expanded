...
public class VoidBoltProjectile extends FollowingProjectile
{
    public VoidBoltProjectile() 
    {
        super();
    }
  ...
  public Color getParticleColor() {
    return new Color(69, 0, 110);
  }
  
  public Trail getTrail() {
    return new Trail(this, getLevel(), new Color(69, 0, 110), 6.0F, 500, 18.0F);
  }
