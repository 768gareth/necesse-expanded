...
public class SkeletonRaider extends ItemAttackerRaiderMob
{
    public SkeletonRaider() 
    {
        ...
        (
            new InventoryItem("tungstensword"),
            new InventoryItem("tungstenspear"),
            new InventoryItem("tungstenbow"),
            new InventoryItem("tungstengreatbow"),
            new InventoryItem("shotgun")
        );
    }
    ...
    public LootTable getLootTable() 
    {
        ...
        (
            ...
            { 
                ...
                (LootItemInterface)new ChanceLootItem(0.10F, "tungstenore", 2),
    ...
    HumanDrawOptions humanOptions = (new HumanDrawOptions(level, MobRegistry.Textures.skeleton)).sprite(sprite).mask(swimMask).dir(dir).light(light);
    if (inLiquid) {
    ...
    public void drawOnMap(TickManager tickManager, Client client, int x, int y, double tileScale, Rectangle drawBounds, boolean isMinimap) 
    {
        ...
        HumanDrawOptions humanOptions = (new HumanDrawOptions(getLevel(), MobRegistry.Textures.skeleton)).sprite(sprite).dir(dir).size(32, 32);
