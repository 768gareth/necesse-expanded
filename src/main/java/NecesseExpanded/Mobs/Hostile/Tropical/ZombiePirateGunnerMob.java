package NecesseExpanded.Mobs.Hostile.Tropical;
...
public class ZombiePirateGunnerMob extends HostileItemAttackerMob
{
    ...
    public LootTable getLootTable() 
    {
      ...
      (
        ...
        {
            new ChanceLootItem(0.25f, "simplebullet", GameRandom.globalRandom.getIntBetween(8, 16))
        }
    );
    }
