package NecesseExpanded.Mobs.Hostile.Fishian;
...
public class FishianChampionMob extends HostileItemAttackerMob
{
    ...
    public FishianChampionMob()
    {
        ...
        this.weapon = new InventoryItem("venomslasher");
    ...
    public LootTable getLootTable() 
    {
      ...
      (
        ...
        {
            new LootItem("myceliumbar", GameRandom.globalRandom.getIntBetween(3, 6))
        }
    );
    }
