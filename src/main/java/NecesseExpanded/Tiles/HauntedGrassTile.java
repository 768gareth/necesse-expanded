...
public class HauntedGrassTile extends TerrainSplatterTile {
  ...
  public static void addSimulateGrow(Level level, int tileX, int tileY, double growChance, long ticks,
      String growObjectID, SimulatePriorityList list, boolean sendChanges) {
    addSimulateGrow(level, tileX, tileY, growChance, ticks, growObjectID,
        (object, l, x, y, r) -> (object.canPlace(l, x, y, r, false) == null), list, sendChanges);
  }

  public static void addSimulateGrow(Level level, int tileX, int tileY, double growChance, long ticks,
      String growObjectID, CanPlacePredicate canPlace, SimulatePriorityList list, boolean sendChanges) {
